...
def sonarTest() {
    ...
    sh 'mvn clean verify sonar:sonar  -Dmaven.test.skip=true  -Dsonar.projectKey=project-devops   -Dsonar.host.url=http://172.21.0.3:9000   -Dsonar.login=sqp_114f7278795d345ede80d4d31a39c9bd382db6dd'
}
