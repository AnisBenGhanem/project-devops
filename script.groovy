...
def sonarTest() {
    ...
    sh 'mvn clean verify sonar:sonar   -Dsonar.projectKey=DevOpsProject   -Dsonar.host.url=http://localhost:9000   -Dsonar.login=sqp_c114049756b2a45c74b9a78aec56f2d48134dd4b'
}
